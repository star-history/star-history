  ...
  },
  {
    ...
    linkList: [
      ...
      },
      {
        title: 'Model',
        path:
          'https://star-history.com/#CompVis/stable-diffusion&lllyasviel/ControlNet&openai/whisper&facebookresearch/llama&databrickslabs/dolly&tatsu-lab/stanford_alpaca&nomic-ai/gpt4all&Stability-AI/StableLM',
      },
      {
  ...
  },
  {
    ...
    linkList: [
      ...
      },
      {
        ...
        path:
          'https://star-history.com/#temporalio/temporal&apache/dolphinscheduler&apache/airflow&quartz-scheduler/quartz&netflix/conductor',
      },
    ],
  },
  {
    ...
    linkList: [
      {
        ...
        path:
          'https://star-history.com/blog/star-history-yearly-pick-2022-data-infra-devtools',
      },
      {
        title: 'Platform Engineering',
        path:
          'https://star-history.com/blog/star-history-open-source-2022-platform-engineering',
      },
      {
        title: 'Open-Source Alternatives',
        path:
          'https://star-history.com/blog/star-history-open-source-2022-open-source-alternatives',
      },
      {
        title: 'Front-end',
