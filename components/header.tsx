...
const Header: React.FC = () => {
    ...
    return (
        <>
            {showSetTokenDialog && <TokenSettingDialog onClose={handleSetTokenDialogClose} tokenCache={false} onTokenChange={handleTokenChange} onHeaderTextChange={setHeaderText} />}
            <AppStateProvider>
                <TopBanner />
