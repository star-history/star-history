      ...
      <div className="max-w-2xl h-auto flex flex-col justify-start items-start bg-white rounded-md">
        ...
        <main className="w-full flex flex-col justify-start items-start p-4 pr-5">
          <p>
            ...
            , and paste it into the textbox below (no scope to your personal
            data is needed).
          </p>
          <p className="leading-8 mt-4">
            <span className="text-red-600">*</span> Access Token
          </p>
          <p className="rounded-md font-bold text-sm text-red-600">
          ...
          <input
            ...
            type="text"
          />
          <p className="leading-8 mt-4 mb-1">
          ...
          <div className="relative w-full h-auto border px-4 py-3 pb-14 rounded-md shadow-inner">
            <p className="font-mono break-all text-gray-600 text-sm">
              {state.embedCode}
            </p>
            <button
              className="absolute bottom-2 right-2 px-4 leading-10 rounded-md bg-green-600 shadow-inner text-light hover:bg-green-700"
